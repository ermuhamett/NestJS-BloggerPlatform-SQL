...
export class CreateUsersTable1722509346394 implements MigrationInterface {
  name = 'CreateUsersTable1722509346394';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "session" ("deviceId" uuid NOT NULL DEFAULT uuid_generate_v4(), "ip" character varying(255) NOT NULL, "deviceName" character varying(255) NOT NULL, "createdAt" bigint NOT NULL, "expirationDate" bigint NOT NULL, "userId" uuid, CONSTRAINT "PK_c57e995074bf9afc1a2953d2329" PRIMARY KEY ("deviceId"))`,
    );
    await queryRunner.query(
